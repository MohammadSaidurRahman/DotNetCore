...
using DotNetCoreProject_Sayed.Repositories;

namespace DotNetCoreProject_Sayed
{
    public class Startup
    {
        ...
        .AddEntityFrameworkStores<ApplicationDbContext>();
            ...
            services.AddTransient<IBookingRepository, BookingReposirory>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "Route01",
                    template: "{controller=FoodItem}/{action=Index}");
            });
